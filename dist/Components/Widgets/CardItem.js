...
var CardItemNB = function (_NativeBaseComponent) {
    ...
    _createClass(CardItemNB, [{
        ...
        value: function imagePresent() {
            ...
            _react2.default.Children.forEach(this.props.children, function (child) {
                if (child.type == _reactNativeWebExtended.Image) imagePresent = true;
            });
        ...
        value: function getChildProps(child) {
            var defaultProps = {};
            if (child.type == _reactNativeWebExtended.Image && !Array.isArray(this.props.children)) {
                defaultProps = {
                    resizeMode: 'stretch',
            ...
            } else if (child.type == _reactNativeWebExtended.Image) {
                defaultProps = {
                    style: this.getInitialStyle().fullImage
                };
            } else {
