    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { style: { flex: 1 } },
                _react2.default.createElement(_reactNativeWebExtended.TextInput, _extends({}, this.prepareRootProps(), { placeholderTextColor: this.props.placeholderTextColor ? this.props.placeholderTextColor : this.getTheme().inputColorPlaceholder, underlineColorAndroid: 'rgba(0,0,0,0)' }))
            );
        }
    }]);
