    ...
    _createClass(ListNB, [{
        ...
        value: function render() {
            if (this.props.dataArray && this.props.renderRow) {
                var ds = new _reactNativeWebExtended.ListView.DataSource({ rowHasChanged: function rowHasChanged(r1, r2) {
                        return r1 !== r2;
                    } });
                var dataSource = ds.cloneWithRows(this.props.dataArray);
                return _react2.default.createElement(_reactNativeWebExtended.ListView, _extends({}, this.prepareRootProps(), {
