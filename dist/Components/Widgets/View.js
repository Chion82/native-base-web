...
var ViewNB = function (_NativeBaseComponent) {
	...
	_createClass(ViewNB, [{
		...
		value: function render() {
			return _react2.default.createElement(_reactNativeWebExtended.View, _extends({ style: { padding: this.props.padder ? this.getTheme().contentPadding : 0, flex: 1 } }, this.props));
		}
	}]);
