...
var CardSwiper = function (_NativeBaseComponent) {
    ...
    function CardSwiper(props) {
        ...
        _this.state = {
            pan: new _reactNativeWebExtended.Animated.ValueXY(),
            enter: new _reactNativeWebExtended.Animated.Value(0.5)
        };
        return _this;
    }
    ...
    _createClass(CardSwiper, [{
        ...
        value: function _animateEntrance() {
            _reactNativeWebExtended.Animated.spring(this.state.enter, { toValue: 1, friction: 8 }).start();
        }
    }, {
        ...
        value: function componentWillMount() {
            ...
            this._panResponder = _reactNativeWebExtended.PanResponder.create({
                ...
                onPanResponderMove: _reactNativeWebExtended.Animated.event([null, { dx: this.state.pan.x, dy: this.state.pan.y }]),
                ...
                onPanResponderRelease: function onPanResponderRelease(e, _ref) {
                    ...
                    if (Math.abs(_this2.state.pan.x._value) > SWIPE_THRESHOLD) {
                        ...
                        _reactNativeWebExtended.Animated.decay(_this2.state.pan, {
                            velocity: { x: velocity, y: vy },
                            deceleration: 0.98
                        }).start(_this2._resetState.bind(_this2));
                    } else {
                        _reactNativeWebExtended.Animated.spring(_this2.state.pan, {
                            toValue: { x: 0, y: 0 },
                            friction: 4
                        }).start();
                    }
