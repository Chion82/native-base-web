  ...
  _createClass(DefaultTabBar, [{
    ...
    value: function renderTabOption(name, page) {
      ...
      return _react2.default.createElement(
        _reactNativeWebExtended.TouchableHighlight,
        { underlayColor: this.getTheme().darkenHeader, style: [this.getInitialStyle().tab], key: name, onPress: function onPress() {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Text2.default,
            { style: { color: isTabActive ? this.getTheme().tabTextColor : this.getTheme().tabTextColor, fontWeight: isTabActive ? 'bold' : 'normal', fontSize: this.getTheme().tabFontSize } },
            name
          )
        )
      );
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactNativeWebExtended.Animated.View, { style: [tabUnderlineStyle, { left: left }] })
      );
    }
  }]);
