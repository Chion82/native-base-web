...
var deviceScreen = _reactNativeWebExtended.Dimensions.get('window');
...
var Drawer = function (_Component) {
  ...
  function Drawer(props) {
    ...
    _this.processTapGestures = function () {
      if (_this._activeTween) return false; // disable tap gestures during tween
    ...
    _this.handleStartShouldSetPanResponderCapture = _this.handleStartShouldSetPanResponderCapture.bind(_this);
    _this.handleStartShouldSetPanResponder = _this.handleStartShouldSetPanResponder.bind(_this);
    _this.handleMoveShouldSetPanResponderCapture = _this.handleMoveShouldSetPanResponderCapture.bind(_this);
    ...
    _this.shouldOpenDrawer = _this.shouldOpenDrawer.bind(_this);
    _this.testPanResponderMask = _this.testPanResponderMask.bind(_this);
    _this.getMainView = _this.getMainView.bind(_this);
    _this.getDrawerView = _this.getDrawerView.bind(_this);
    _this.getOpenLeft = _this.getOpenLeft.bind(_this);
    _this.getClosedLeft = _this.getClosedLeft.bind(_this);
    _this.getMainWidth = _this.getMainWidth.bind(_this);
    _this.getDrawerWidth = _this.getDrawerWidth.bind(_this);
    _this.initialize = _this.initialize.bind(_this);
    _this.handleSetViewport = _this.handleSetViewport.bind(_this);
    _this.resync = _this.resync.bind(_this);
    _this.requiresResync = _this.requiresResync.bind(_this);

    _this.propsWhomRequireUpdate = ['closedDrawerOffset', 'openDrawerOffset', 'type'];

    _this.state = { viewport: props.deviceScreen };
    return _this;
  }
  ...
  _createClass(Drawer, [{
    ...
    value: function getMainView() {
      ...
      return _react2.default.createElement(
        ...
        this.props.children,
        this.props.type === 'overlay' ? _react2.default.createElement(_reactNativeWebExtended.View, {
          ref: function ref(c) {
    ...
    value: function initialize(props) {
      ...
      if (this.main) {
        ...
        this.stylesheet = _reactNativeWebExtended.StyleSheet.create(styles);
        this.responder = _reactNativeWebExtended.PanResponder.create({
...
Drawer.tweenPresets = {
  parallax: function parallax(ratio) {
    var side = arguments.length <= 1 || arguments[1] === undefined ? 'left' : arguments[1];
...
Drawer.propTypes = {
  acceptDoubleTap: _react2.default.PropTypes.bool,
  acceptPan: _react2.default.PropTypes.bool,
  acceptTap: _react2.default.PropTypes.bool,
  captureGestures: _react2.default.PropTypes.bool,
  children: _react2.default.PropTypes.node,
  closedDrawerOffset: _react2.default.PropTypes.number,
  content: _react2.default.PropTypes.node,
  deviceScreen: _react2.default.PropTypes.object,
  disabled: _react2.default.PropTypes.bool,
  initializeOpen: _react2.default.PropTypes.bool,
  negotiatePan: _react2.default.PropTypes.bool,
  onClose: _react2.default.PropTypes.func,
  onCloseStart: _react2.default.PropTypes.func,
  onOpen: _react2.default.PropTypes.func,
  onOpenStart: _react2.default.PropTypes.func,
  openDrawerOffset: _react2.default.PropTypes.number,
  openDrawerThreshold: _react2.default.PropTypes.number,
  panCloseMask: _react2.default.PropTypes.number,
  panOpenMask: _react2.default.PropTypes.number,
  panStartCompensation: _react2.default.PropTypes.bool,
  relativeDrag: _react2.default.PropTypes.bool,
  side: _react2.default.PropTypes.oneOf(['left', 'right']),
  styles: _react2.default.PropTypes.object,
  tapToClose: _react2.default.PropTypes.bool,
  tweenDuration: _react2.default.PropTypes.number,
  tweenEasing: _react2.default.PropTypes.string,
  tweenHandler: _react2.default.PropTypes.func,
  type: _react2.default.PropTypes.oneOf(['overlay', 'static', 'displace'])
};
Drawer.defaultProps = {
  type: 'displace',
...
Drawer.childContextTypes = {
  drawer: _react.PropTypes.any
};


var styles = _reactNativeWebExtended.StyleSheet.create({
  mainOverlay: {
    width: 0,
    left: 0,
    top: 0,
